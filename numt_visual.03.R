...
dir_work <- 'C:/Users/myucchen/Dropbox/VHF274/Side_project/Aure_swarmgenomics/visual_numt/'
setwd(dir_work)
...
mt_seq <- readDNAStringSet('animal_mt.K85.scaffolds.graph1.1.path_sequence.fasta')
len <- width(mt_seq)

mt_info <- read.table('extended_K85.assembly_graph.fastg.extend-animal_mt.csv', header = T, stringsAsFactors = F)
...
png("circos_plot.rec.png", width = 4000, height = 4000, res = 300)
circos.clear()
